/**********************************************************************************************************************
    Program Name    : Sample program for Renesas Flash Sample Program (RFSP Type01 for RL78/G15) (Data Flash)
    
    File Name       : sample_dataflash_config.h
    Program Version : V1.00.00
    Device(s)       : RL78/G15 microcontroller
...
#define DF_WRITE_ADDRESS          (0x9000uL)

/**** Data length to write ****/
/* Don't across the boundary of the flash block. */
#define DF_WRITE_DATA_LENGTH      (16u)  //(64u)
