...
#pragma interrupt r_Config_INTC_intp7_interrupt(vect=INTP7)
#pragma interrupt r_Config_INTC_intp8_interrupt(vect=INTP8)
#pragma interrupt r_Config_INTC_intp9_interrupt(vect=INTP9)
...
static void __near r_Config_INTC_intp8_interrupt(void)
{
    ...
    EXT_INT2_Process_in_IRQ();
    /* End user code. Do not edit comment generated here */
}

/***********************************************************************************************************************
* Function Name: r_Config_INTC_intp9_interrupt
* Description  : This function is INTP9 interrupt service routine.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
static void __near r_Config_INTC_intp9_interrupt(void)
{
    /* Start user code for r_Config_INTC_intp9_interrupt. Do not edit comment generated here */
    EXT_INT3_Process_in_IRQ();
    /* End user code. Do not edit comment generated here */
}
