...
Pragma directive
***********************************************************************************************************************/
#pragma interrupt r_Config_TAU0_4_channel4_interrupt(vect=INTTM04)
#pragma interrupt r_Config_TAU0_4_channel7_interrupt(vect=INTTM07)
...
void R_Config_TAU0_4_Create_UserInit(void)
{
    ...
    set_TAU0_4_pwm_ch_duty(get_TAU0_4_pwm_ch_data_reg());
    /* End user code. Do not edit comment generated here */
}
...
* Return Value : None
***********************************************************************************************************************/
static void __near r_Config_TAU0_4_channel4_interrupt(void)
{
...
/***********************************************************************************************************************
* Function Name: r_Config_TAU0_4_channel7_interrupt
* Description  : This function is INTTM07 interrupt service routine.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
static void __near r_Config_TAU0_4_channel7_interrupt(void)
{
    /* Start user code for r_Config_TAU0_4_channel7_interrupt. Do not edit comment generated here */
    /* End user code. Do not edit comment generated here */
}
